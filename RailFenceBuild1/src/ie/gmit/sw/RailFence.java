...
public class RailFence {
	...
	public void processDecrypter(){
		...
		{
			//synchronising access to the map should ensure that the map is actually created at this point in case
			//the map read is incomplete
			synchronized (map) {
